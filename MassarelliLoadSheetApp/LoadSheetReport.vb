...
Public Class LoadSheetReport
    ...
    Public Property FullResourceName() As String
        Get
            Return "MassarelliLoadSheetApp.LoadSheetReport.rpt"
        End Get
        Set(value As String)
            'Do nothing
        End Set
    ...
    'Public Class CachedLoadSheetReport
    '    Inherits Component
    ...
    '        Dim rpt As LoadSheetReport = New LoadSheetReport()
    '        rpt.Site = Me.Site
    '        Return rpt
    '    End Function
